...
const About = () => {
    return (
        <WebsiteLayout page="home">
            <main className="text-grey text-lg">
                {/* Governing Board */}
                <p className="text-5xl my-10 font-bold text-primary text-center">
                    Governing Board
                </p>
                ...
                {/* values */}
                <div class="mb-32" style={{ backgroundImage: "url('images/about/bg.jpg')" }}>
                ...
                {/* team */}
                <div className="sm:mx-7 mb-32 text-black">
                        ...
                        <div className="sm:w-[25%] mx-2 mb-4">
                            <Link href="/">
                               <div className="sm:h-[15rem]">
                                <img src="images/homePage/serviceOne.jpg" className="h-[15rem]" alt="" />
                            </div>
                            <div className="p-3 bg-slate-100">
                                <p>Head</p>
