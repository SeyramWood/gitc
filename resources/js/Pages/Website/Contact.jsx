                            ...
                            <div className="grid grid-cols-1 ">
                                <div className="lg:flex  justify-center gap-3 p-3 ">
                                    <input type="text" placeholder="First Name*" required="required"
                                           ...
                                           className="m-1 w-screen  h-full bg-gray-100 border-none focus:outline-none focus:ring focus:ring-primary/20"
                                           id=""/>
                                ...
                                <div className="sm:flex  justify-center gap-3 p-3">
                                    <input type="email" placeholder="Email*" required="required" value={data.email}
                                           onChange={e => setData('email', e.target.value)}
                                           className="m-1 w-screen  h-full  bg-gray-100 border-none focus:outline-none focus:ring focus:ring-primary/20"
                                           id=""/>
                                    <input type="text" placeholder="Phone Number*" value={data.phone}
                                           onChange={e => setData('phone', e.target.value)} required="required"
                                           className="m-1 w-screen  h-full  bg-gray-100 border-none focus:outline-none focus:ring focus:ring-primary/20"
                                           id=""/>
                                </div>
                                <div className="sm:flex  justify-center gap-3 p-3">
                                    <input type="text" placeholder="Company Name*" value={data.company}
                                           onChange={e => setData('company', e.target.value)} required="required"
                                           className="m-1 w-screen  h-full  bg-gray-100 border-none focus:outline-none focus:ring focus:ring-primary/20"
                                           id=""/>
                                    <input type="text" placeholder="Industry*" value={data.industry}
                                           onChange={e => setData('industry', e.target.value)} required="required"
                                           className="m-1 w-screen  h-full  bg-gray-100 border-none focus:outline-none focus:ring focus:ring-primary/20"
                                           id=""/>
                                </div>
                                <div className="flex  justify-center gap-3 p-3 mb-2">
                                    <input type="text" placeholder="Subject*" value={data.subject}
                                           onChange={e => setData('subject', e.target.value)} required="required"
                                           className="m-1 w-screen  h-full  bg-gray-100 border-none focus:outline-none focus:ring focus:ring-primary/20"
                                           id=""/>

                                </div>
                                <div className="flex justify-center gap-3 p-3">
                                    <textarea name="" id="" placeholder="Message" value={data.message}
                                              onChange={e => setData('message', e.target.value)}
                                              className="m-1 w-screen  h-80  bg-gray-100 border-none focus:outline-none focus:ring focus:ring-primary/20"
                                              rows="0"></textarea>
                                </div>
                                <div className="">
