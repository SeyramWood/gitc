        ...
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsx("div", { className: " mx-auto  text-center sm:translate-y-[12rem] translate-y-[9rem] ", children: /* @__PURE__ */ jsx(AiOutlineLink, { className: "rounded-full translate-x-[9rem] text-white text-[4.5rem] text-center p-6 bg-black/40 hover:bg-black/80" }) }),
              /* @__PURE__ */ jsx(
                "img",
                {
