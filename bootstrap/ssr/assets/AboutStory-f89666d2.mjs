...
const AboutMessage = () => {
  ...
  return /* @__PURE__ */ jsx(WebsiteLayout, { page: "story", children: /* @__PURE__ */ jsxs("div", { className: "bg-white", children: [
    /* @__PURE__ */ jsxs("div", { className: "sm:flex text-center sm:text-left p-4 pt-14 bg-faded", children: [
      /* @__PURE__ */ jsx("div", { className: "sm:w-[20%]  sm:mx-3", children: /* @__PURE__ */ jsx("h4", { className: "text-5xl text-red-600", children: "Our Story" }) }),
      /* @__PURE__ */ jsxs("div", { className: "my-4 sm:w-[80%]  ", children: [
        /* @__PURE__ */ jsx("p", { className: "mb-6 text-black", children: "Ghana International Trade Commission (GITC), was established in September 2016 under Parliamentary Act 926 to provide for the regulation of Ghana’s International Trade inconformity with the rules and regulations of the world trade system and related matters." }),
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-1", style: { backgroundImage: "url('images/contact/contactbanner.jpg')" }, children: /* @__PURE__ */ jsxs("div", { className: "py-10 md:flex justify-center bg-white/40 ", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex p-2 my-5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "w-[70%] sm:pl-5", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-black ", children: "Objectivity" }),
          /* @__PURE__ */ jsx("p", { className: "text-black/100", children: "To ensure equality and fairness in the application of measures affecting international trade and the use of world trade regulations." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex p-2 my-5", children: [
        /* @__PURE__ */ jsx("div", { className: "p-3 w-[30%] ", children: /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsxs("div", { className: "w-[70%] ", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-black", children: "Professionalism" }),
          /* @__PURE__ */ jsx("p", { className: "text-black/100", children: "To ensure a high level of competence and efficiency in applying international trade rules and regulations as under the World Trade Organization (WTO) provisions." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex p-2 my-5", children: [
        /* @__PURE__ */ jsx("div", { className: "p-3 w-[30%] ", children: /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsxs("div", { className: "w-[70%] ", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-black ", children: "Integrity" }),
          /* @__PURE__ */ jsx("p", { className: "text-black/100", children: "To ensure absolute neutrality and consistency in the execution of the mandate of the Commission." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex p-2 my-5", children: [
        /* @__PURE__ */ jsx("div", { className: "p-3 w-[30%] ", children: /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-1", children: /* @__PURE__ */ jsxs("div", { className: "mb-16", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col-reverse justify-center sm:flex-row ", children: [
        /* @__PURE__ */ jsx("div", { className: "text-white  bg-black sm:w-[50%]", children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("h2", { className: "text-[3rem] text-white pt-4  font-bold", children: "We ensure:" }),
              /* @__PURE__ */ jsxs("ul", { className: "sm:text-[1.1rem] list-disc pb-5 px-4 ", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "sm:w-[50%]", children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("h4", { className: "text-left font-bold text-white pt-6", children: "Vission" }),
              /* @__PURE__ */ jsx("p", { className: " text-[1.5rem] text-white", children: "To become world-class fair trade regulatory agency." })
            ]
          }
        ) })
      ] })
