...
function Resources() {
  ...
  return /* @__PURE__ */ jsx(WebsiteLayout, { page: "resource", children: /* @__PURE__ */ jsxs("div", { className: "bg-white py-16  overflow-hidden", children: [
    /* @__PURE__ */ jsx("div", { className: "grid w-[70%] sm:grid-cols-2 gap-16 mx-auto sm:px-16", children: data.map((item, index) => /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "mx-auto ", children: [
          /* @__PURE__ */ jsx(AiOutlineFilePdf, { className: "text-[20rem] w-[100%] text-center text-red-700 " }),
          /* @__PURE__ */ jsx("p", { className: "text-center px-3 ", children: item.name })
        ] })
      },
      index
    )) }),
