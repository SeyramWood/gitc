...
const BannerAbout = () => {
  return /* @__PURE__ */ jsx("section", { className: "banner__static about h-[var(--banner-height-sm)] md:h-[var(--banner-height-sm)] lg:h-[var(--banner-height)]", children: /* @__PURE__ */ jsx("article", { className: "text-white banner__static__article", children: /* @__PURE__ */ jsx("h1", { className: "text-5xl lg:text-6xl text-bold", children: "About Us" }) }) });
};
...
const Publication = () => {
  return /* @__PURE__ */ jsx("section", { className: "banner__static publication h-[var(--banner-height-sm)] md:h-[var(--banner-height-sm)] lg:h-[var(--banner-height)]", children: /* @__PURE__ */ jsx("article", { className: "text-white banner__static__article", children: /* @__PURE__ */ jsx("h1", { className: "text-5xl lg:text-6xl text-bold", children: "Publications" }) }) });
};
const Story = () => {
          ...
          /* @__PURE__ */ jsx("div", { className: "flex h-screen-sm mobile__navigation__menu__items__wrapper", children: /* @__PURE__ */ jsxs("ul", { className: "flex-column items-center justify-center h-screen-sm w-screen-sm [&>li>a, &>li>span]:opacity-70 text-md font-semibold relative", children: [
            ...
            /* @__PURE__ */ jsxs("li", { className: "hover:opacity-100", children: [
              ...
              /* @__PURE__ */ jsxs("ul", { className: " text-white [&>li>a]:text-md dropdown opacity-60 [&>li>a]:font-thin [&>li:hover>a]:text-primary-light", children: [
                ...
                /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: "/cases/anti-dumping", children: "Cases" }) })
              ] })
            ] }),
