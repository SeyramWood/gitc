  ...
  return /* @__PURE__ */ jsx(WebsiteLayout, { page: "story", children: /* @__PURE__ */ jsxs("div", { className: "bg-white", children: [
    /* @__PURE__ */ jsxs("div", { className: "sm:flex text-center sm:text-left p-4 pt-14 bg-faded", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "my-4 sm:w-[80%]  ", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mb-6 text-black", children: "However, in Africa the trade remedy laws and Investigating authorities are in Egypt, SouthAfrica, Morocco, Tunisia, Mauritius and Madagascar. In the developed world, however, such institutions have existed for along time such as in the United States where the U.S International Trade Commission (USITC) was set up in September 1916." })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "mt-32", style: { backgroundImage: "url('images/contact/contactbanner.jpg')" }, children: /* @__PURE__ */ jsxs("div", { className: "py-10 md:flex justify-center bg-white/20 ", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex p-2 my-5", children: [
        /* @__PURE__ */ jsx("div", { className: "p-3 w-[35%] ", children: /* @__PURE__ */ jsx("div", { className: "sm:bg-black/5", style: { borderRadius: "100%" }, children: /* @__PURE__ */ jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "w-[65%] ", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "my-32", children: /* @__PURE__ */ jsxs("div", { className: "mb-16", children: [
