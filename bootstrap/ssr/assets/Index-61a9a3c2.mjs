...
const Index = () => {
  ...
  return /* @__PURE__ */ jsx(WebsiteLayout, { page: "home", children: /* @__PURE__ */ jsxs("div", { className: "text-lg bg-white ", children: [
    /* @__PURE__ */ jsx("div", { className: "px-2 mb-32 sm:py-10 bg-faded ", children: /* @__PURE__ */ jsxs("div", { className: "", "data-aos": "fade-up", "data-aos-duration": "2000", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-center text-[3rem] sm:text-[5rem] pt-8 sm:pb-7 pb-4 text-grey/40", children: "Our Values" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "justify-center gap-6 md:flex sm:mt-13 ", children: [
        /* @__PURE__ */ jsxs("div", { className: "sm:w-[25%]", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "my-2 ", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "mb-3", children: "To provide actions that ensure domestic producers / industries are protected from dumping, subsidization, and influx of imported products." }),
            /* @__PURE__ */ jsx(
              Link,
              {
                href: "/services",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col-reverse justify-center bg-black sm:flex sm:flex-row ", children: [
        /* @__PURE__ */ jsx("div", { className: "text-white sm:w-[50%] bg-red-700", children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            "data-aos-duration": "2000",
            children: [
              /* @__PURE__ */ jsx("h2", { className: " my-6 font-bold text-white sm:text-3xl", children: "The bane of development in developing countries as against developed countries is the lack of industrialization in the former. The inability of developing counties ..." }),
              /* @__PURE__ */ jsx(Link, { href: "/story", children: /* @__PURE__ */ jsx(ButtonOutline, { className: "sm:w-[14rem] my-6 bg-white text-primary border-white/40 hover:bg-red-100/40 hover:text-white ", children: "Read Our Message" }) }),
    ...
    /* @__PURE__ */ jsx("div", { className: "w-full px-2 pb-16 justify-content-center text-center", children: /* @__PURE__ */ jsx("div", { className: "flex pb-4", children: /* @__PURE__ */ jsx("div", { className: "mx-auto px-3 ", children: /* @__PURE__ */ jsxs("div", { className: "bg-red-100/90 rounded shadow-xl", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "pb-16", children: /* @__PURE__ */ jsx("form", { action: "", className: "sm:w-[40rem]", children: /* @__PURE__ */ jsxs("div", { className: "px-2 ", children: [
        /* @__PURE__ */ jsx("input", { type: "email", className: "rounded w-[60%]  mr-3", placeholder: "Enter Your Email" }),
        /* @__PURE__ */ jsx("button", { className: "py-2 sm:px-3 px-2 rounded border text-white bg-red-500 hover:bg-red-400 hover:text-white ", children: "Subscribe" })
      ] }) }) })
    ] }) }) }) })
  ] }) });
};
