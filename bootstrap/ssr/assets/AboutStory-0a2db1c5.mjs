...
const AboutMessage = () => {
  ...
  return /* @__PURE__ */ jsx(WebsiteLayout, { page: "story", children: /* @__PURE__ */ jsxs("div", { className: "bg-white", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-32", style: { backgroundImage: "url('images/bg.jpg')", objectFit: "cover" }, children: /* @__PURE__ */ jsxs("div", { className: "sm:p-10 p-4 md:flex justify-center bg-white/70 ", children: [
