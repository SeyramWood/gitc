...
const ButtonOutline = (props) => {
  return /* @__PURE__ */ jsx("button", { className: `block p-4 border rounded-full border-primary hover:border-2 ${props.className}`, children: props.children });
};
...
const Index = () => {
  ...
  return /* @__PURE__ */ jsx(WebsiteLayout, { page: "home", children: /* @__PURE__ */ jsxs("div", { className: "text-lg bg-white text-grey", children: [
    /* @__PURE__ */ jsx("div", { className: "mb-32 sm:p-10 bg-faded ", children: /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex p-2 my-5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "w-[70%] ", children: [
              /* @__PURE__ */ jsx("h2", { className: "font-bold ", children: "Integrity" }),
              /* @__PURE__ */ jsx("p", { children: "To ensure absolute neutrality and consistency in the execution of the mandate of the Commission." })
            ] })
          ] })
        ]
    ...
    /* @__PURE__ */ jsxs("div", { className: "pb-28 ", children: [
      /* @__PURE__ */ jsxs("div", { className: "justify-center md:flex", children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            className: "sm:w-[25%]",
    ...
    /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsx("div", { className: "shadow-2xl px-9", children: /* @__PURE__ */ jsxs("div", { className: "", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-white", children: /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("h2", { className: "my-5 font-bold text-center text-red-600 sm:text-left sm:text-3xl", children: "GITC is among seven trade remedy institutions and investigating authorities in Africa." }),
              /* @__PURE__ */ jsx("p", { className: "mb-5 text-center text-red-400 sm:mb-14 sm:text-left", children: "These other African countries are: Egypt, South Africa, Morocco, Tunisia, Mauritius, and Madagascar. These other African countries are: Egypt,South Africa, Morocco, Tunisia, Mauritius, and Madagascar." }),
              /* @__PURE__ */ jsx(Link, { href: "/story", children: /* @__PURE__ */ jsx(ButtonOutline, { className: "sm:w-[14rem] mb-7", children: "Read Our Story" }) })
            ]
          }
        ) })
      ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "py-10 mb-1 bg-gray-100", children: /* @__PURE__ */ jsx("div", { className: "", children: /* @__PURE__ */ jsx("div", { className: "flex justify-center gap-1 h-10rem]", children: /* @__PURE__ */ jsxs("div", { ref: sliderRef, className: "keen-slider", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "pb-24 ", children: /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "justify-center  sm:flex sm:w-[100%]", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "sm:w-[50%] bg-white sm:px-8", children: /* @__PURE__ */ jsxs("div", { className: "container sm:pt-32", children: [
            /* @__PURE__ */ jsx(
              "img",
              {
